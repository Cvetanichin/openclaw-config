...
complete -c openclaw -n "__fish_use_subcommand" -a "setup" -d 'Initialize the active OpenClaw config and agent workspace'
complete -c openclaw -n "__fish_use_subcommand" -a "onboard" -d 'Interactive onboarding for the gateway, workspace, and skills'
...
complete -c openclaw -n "__fish_use_subcommand" -a "config" -d 'Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.'
...
complete -c openclaw -n "__fish_use_subcommand" -a "qr" -d 'Generate an iOS pairing QR code and setup code'
...
complete -c openclaw -n "__fish_use_subcommand" -a "memory" -d 'Search, inspect, and reindex memory files'
...
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l wizard -d 'Run interactive onboarding'
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l non-interactive -d 'Run onboarding without prompts'
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l mode -d 'Onboard mode: local|remote'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l reset -d 'Reset config + credentials + sessions before running onboard (workspace only with --reset-scope full)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l reset-scope -d 'Reset scope: config|config+creds+sessions|full'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l secret-input-mode -d 'API key persistence mode: plaintext|ref (default: plaintext)'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l chutes-api-key -d 'Chutes API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l deepseek-api-key -d 'DeepSeek API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l fal-api-key -d 'fal API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l kilocode-api-key -d 'Kilo Gateway API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l kimi-code-api-key -d 'Kimi Code API key (subscription)'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l mistral-api-key -d 'Mistral API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-standard-api-key-cn -d 'Alibaba Cloud Model Studio Standard API key (China)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-standard-api-key -d 'Alibaba Cloud Model Studio Standard API key (Global/Intl)'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-api-key -d 'Custom provider API key (optional)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-model-id -d 'Custom provider model ID'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-provider-id -d 'Custom provider ID (optional; auto-derived by default)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-compatibility -d 'Custom provider API compatibility: openai|anthropic (default: openai)'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l gateway-token-ref-env -d 'Gateway token SecretRef env var name (token auth; e.g. OPENCLAW_GATEWAY_TOKEN)'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l skip-search -d 'Skip search provider setup'
...
complete -c openclaw -n "__fish_seen_subcommand_from config" -a "set" -d 'Set config values by path (value mode, ref/provider builder mode, or batch JSON mode).
Examples:
...
complete -c openclaw -n "__fish_seen_subcommand_from config" -a "file" -d 'Print the active config file path'
complete -c openclaw -n "__fish_seen_subcommand_from config" -a "schema" -d 'Print the JSON schema for openclaw.json'
complete -c openclaw -n "__fish_seen_subcommand_from config" -a "validate" -d 'Validate the current config against the schema without starting the gateway'
complete -c openclaw -n "__fish_seen_subcommand_from config" -l section -d 'Configuration sections for guided setup (repeatable). Use with no subcommand.'
complete -c openclaw -n "__fish_seen_subcommand_from get" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l strict-json -d 'Strict JSON parsing (error instead of raw string fallback)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l json -d 'Legacy alias for --strict-json'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l dry-run -d 'Validate changes without writing openclaw.json (checks run in builder/json/batch modes; exec SecretRefs are skipped unless --allow-exec is set)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l allow-exec -d 'Dry-run only: allow exec SecretRef resolvability checks (may execute provider commands)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l ref-provider -d 'SecretRef builder: provider alias'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l ref-source -d 'SecretRef builder: source (env|file|exec)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l ref-id -d 'SecretRef builder: ref id'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-source -d 'Provider builder: source (env|file|exec)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-allowlist -d 'Provider builder (env): allowlist entry (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-path -d 'Provider builder (file): path'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-mode -d 'Provider builder (file): mode (singleValue|json)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-timeout-ms -d 'Provider builder (file|exec): timeout ms'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-max-bytes -d 'Provider builder (file): max bytes'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-command -d 'Provider builder (exec): absolute command path'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-arg -d 'Provider builder (exec): command arg (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-no-output-timeout-ms -d 'Provider builder (exec): no-output timeout ms'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-max-output-bytes -d 'Provider builder (exec): max output bytes'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l provider-json-only -d 'Provider builder (exec): require JSON output'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l interactive -d 'Shared interactive payload as JSON (buttons/selects rendered natively by supported channels)'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l components -d 'Discord components payload as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l force-document -d 'Send media as document to avoid Telegram compression (Telegram only). Applies to images and GIFs.'
complete -c openclaw -n "__fish_seen_subcommand_from send" -l silent -d 'Send message silently without notification (Telegram + Discord)'
complete -c openclaw -n "__fish_seen_subcommand_from send" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from broadcast" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l poll-duration-hours -d 'Poll duration in hours (Discord)'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l poll-duration-seconds -d 'Poll duration in seconds (Telegram; 5-600)'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l poll-anonymous -d 'Send an anonymous poll (Telegram)'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l poll-public -d 'Send a non-anonymous poll (Telegram)'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -s m -l message -d 'Optional message body'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l silent -d 'Send poll silently without notification (Telegram + Discord where supported)'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l thread-id -d 'Thread id (Telegram forum topic / Slack thread ts)'
...
complete -c openclaw -n "__fish_seen_subcommand_from react" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from pin" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from pins" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from reply" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from upload" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from timeout" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from kick" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from ban" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line'
...
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l channel -d 'Delivery channel: last|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line (omit to use the main session channel)'
...
complete -c openclaw -n "__fish_seen_subcommand_from agents" -a "bindings" -d 'List routing bindings'
complete -c openclaw -n "__fish_seen_subcommand_from agents" -a "bind" -d 'Add routing bindings for an agent'
complete -c openclaw -n "__fish_seen_subcommand_from agents" -a "unbind" -d 'Remove routing bindings for an agent'
...
complete -c openclaw -n "__fish_seen_subcommand_from bindings" -l agent -d 'Filter by agent id'
complete -c openclaw -n "__fish_seen_subcommand_from bindings" -l json -d 'Output JSON instead of text'
complete -c openclaw -n "__fish_seen_subcommand_from bind" -l agent -d 'Agent id (defaults to current default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from bind" -l bind -d 'Binding to add (repeatable). If omitted, accountId is resolved by channel defaults/hooks.'
complete -c openclaw -n "__fish_seen_subcommand_from bind" -l json -d 'Output JSON summary'
complete -c openclaw -n "__fish_seen_subcommand_from unbind" -l agent -d 'Agent id (defaults to current default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from unbind" -l bind -d 'Binding to remove (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from unbind" -l all -d 'Remove all bindings for this agent'
complete -c openclaw -n "__fish_seen_subcommand_from unbind" -l json -d 'Output JSON summary'
...
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -a "cleanup" -d 'Run session-store maintenance now'
...
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -l agent -d 'Agent id to inspect (default: configured default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -l all-agents -d 'Aggregate sessions across all configured agents'
...
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l store -d 'Path to session store (default: resolved from config)'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l agent -d 'Agent id to maintain (default: configured default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l all-agents -d 'Run maintenance across all configured agents'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l dry-run -d 'Preview maintenance actions without writing'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l enforce -d 'Apply maintenance even when configured mode is warn'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l fix-missing -d 'Remove store entries whose transcript files are missing (bypasses age/count retention)'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l active-key -d 'Protect this session key from budget-eviction'
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "list" -d 'List tracked background tasks'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "audit" -d 'Show stale or broken background tasks and TaskFlows'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "maintenance" -d 'Preview or apply tasks and TaskFlow maintenance'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "show" -d 'Show one background task by task id, run id, or session key'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "notify" -d 'Set task notify policy'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "cancel" -d 'Cancel a running background task'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "flow" -d 'Inspect durable TaskFlow state under tasks'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -l runtime -d 'Filter by kind (subagent, acp, cron, cli)'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -l status -d 'Filter by status (queued, running, succeeded, failed, timed_out, cancelled, lost)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l runtime -d 'Filter by kind (subagent, acp, cron, cli)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l status -d 'Filter by status (queued, running, succeeded, failed, timed_out, cancelled, lost)'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l severity -d 'Filter by severity (warn, error)'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l code -d 'Filter by finding code (stale_queued, stale_running, lost, delivery_failed, missing_cleanup, inconsistent_timestamps, restore_failed, stale_waiting, stale_blocked, cancel_stuck, missing_linked_tasks, blocked_task_missing)'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l limit -d 'Limit displayed findings'
complete -c openclaw -n "__fish_seen_subcommand_from maintenance" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from maintenance" -l apply -d 'Apply reconciliation, cleanup stamping, and pruning'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from flow" -a "list" -d 'List tracked TaskFlows'
complete -c openclaw -n "__fish_seen_subcommand_from flow" -a "show" -d 'Show one TaskFlow by flow id or owner key'
complete -c openclaw -n "__fish_seen_subcommand_from flow" -a "cancel" -d 'Cancel a running TaskFlow'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l status -d 'Filter by status (queued, running, waiting, blocked, succeeded, failed, cancelled, lost)'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l json -d 'Output as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from acp" -l token-file -d 'Read gateway token from file'
complete -c openclaw -n "__fish_seen_subcommand_from acp" -l password -d 'Gateway password (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from acp" -l password-file -d 'Read gateway password from file'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -l auth -d 'Gateway auth mode ("none"|"token"|"password"|"trusted-proxy")'
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -l password -d 'Password for auth mode=password'
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -l password-file -d 'Read gateway password from file'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -l claude-cli-logs -d 'Deprecated alias for --cli-backend-logs'
...
complete -c openclaw -n "__fish_seen_subcommand_from run" -l auth -d 'Gateway auth mode ("none"|"token"|"password"|"trusted-proxy")'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l password -d 'Password for auth mode=password'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l password-file -d 'Read gateway password from file'
...
complete -c openclaw -n "__fish_seen_subcommand_from run" -l claude-cli-logs -d 'Deprecated alias for --cli-backend-logs'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l local-time -d 'Display timestamps in local timezone'
...
complete -c openclaw -n "__fish_seen_subcommand_from nodes" -a "push" -d 'Send an APNs test push to an iOS node'
...
complete -c openclaw -n "__fish_seen_subcommand_from push" -l title -d 'Push title'
complete -c openclaw -n "__fish_seen_subcommand_from push" -l body -d 'Push body'
complete -c openclaw -n "__fish_seen_subcommand_from push" -l environment -d 'Override APNs environment'
...
complete -c openclaw -n "__fish_seen_subcommand_from devices" -a "remove" -d 'Remove a paired device entry'
complete -c openclaw -n "__fish_seen_subcommand_from devices" -a "clear" -d 'Clear paired devices from the gateway table'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l password -d 'Gateway password (password auth)'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l pending -d 'Also reject all pending pairing requests'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l yes -d 'Confirm destructive clear'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l password -d 'Gateway password (password auth)'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from clear" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l latest -d 'Approve the most recent pending request'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l token -d 'Gateway token (if required)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l session-key -d 'Session key for job routing (e.g. agent:my-agent:my-session)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l wake -d 'Wake mode (now|next-heartbeat)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l at -d 'Run once at time (ISO with offset, or +duration). Use --tz for offset-less datetimes'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l every -d 'Run every duration (e.g. 10m, 1h)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l cron -d 'Cron expression (5-field or 6-field with seconds)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l tz -d 'Timezone for cron expressions (IANA)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l stagger -d 'Cron stagger window (e.g. 30s, 5m)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l tools -d 'Comma-separated tool allow-list (e.g. exec,read,write)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|<channel-id>)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l account -d 'Channel account id for delivery (multi-account setups)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l session-key -d 'Set session key for job routing'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l clear-session-key -d 'Unset session key'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l stagger -d 'Cron stagger window (e.g. 30s, 5m)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l no-light-context -d 'Disable lightweight bootstrap context for agent jobs'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l tools -d 'Comma-separated tool allow-list (e.g. exec,read,write)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l clear-tools -d 'Remove tool allow-list (use all tools)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|<channel-id>)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l account -d 'Channel account id for delivery (multi-account setups)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert -d 'Enable failure alerts for this job'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l no-failure-alert -d 'Disable failure alerts for this job'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-after -d 'Alert after N consecutive job errors'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-channel -d 'Failure alert channel (last|<channel-id>)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-to -d 'Failure alert destination'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-cooldown -d 'Minimum time between alerts (e.g. 1h, 30m)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-mode -d 'Failure alert delivery mode (announce or webhook)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-account-id -d 'Account ID for failure alert channel (multi-account setups)'
...
complete -c openclaw -n "__fish_seen_subcommand_from hooks" -a "install" -d 'Deprecated: install a hook pack via `openclaw plugins install`'
complete -c openclaw -n "__fish_seen_subcommand_from hooks" -a "update" -d 'Deprecated: update hook packs via `openclaw plugins update`'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -l pin -d 'Record npm installs as exact resolved <name>@<version>'
...
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l remote -d 'Use gateway.remote.url and gateway.remote token/password (ignores device-pair publicUrl)'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l url -d 'Override gateway URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l public-url -d 'Override gateway public URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l token -d 'Override gateway token for setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l password -d 'Override gateway password for setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l setup-code-only -d 'Print only the setup code'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l no-ascii -d 'Skip ASCII QR rendering'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from clawbot" -a "qr" -d 'Generate an iOS pairing QR code and setup code'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l remote -d 'Use gateway.remote.url and gateway.remote token/password (ignores device-pair publicUrl)'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l url -d 'Override gateway URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l public-url -d 'Override gateway public URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l token -d 'Override gateway token for setup payload'
...
complete -c openclaw -n "__fish_seen_subcommand_from create-profile" -l user-data-dir -d 'User data dir for existing-session Chromium attach'
complete -c openclaw -n "__fish_seen_subcommand_from create-profile" -l driver -d 'Profile driver (openclaw|existing-session). Default: openclaw'
...
complete -c openclaw -n "__fish_seen_subcommand_from stop" -l out -d 'Output path within openclaw temp dir (e.g. trace.zip or /tmp/openclaw/trace.zip)'
...
complete -c openclaw -n "__fish_seen_subcommand_from headers" -l headers-json -d 'JSON object of headers'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l query -d 'Search query (alternative to positional argument)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (whatsapp)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l account -d 'Account id (for multi-account channels)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (whatsapp)'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l account -d 'Account id (for multi-account channels)'
...
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "inspect" -d 'Inspect plugin details'
...
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "uninstall" -d 'Uninstall a plugin'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "install" -d 'Install a plugin or hook pack (path, archive, npm spec, clawhub:package, or marketplace entry)'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "update" -d 'Update installed plugins and tracked hook packs'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "doctor" -d 'Report plugin load issues'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "marketplace" -d 'Inspect Claude-compatible plugin marketplaces'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l all -d 'Inspect all plugins'
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from uninstall" -l keep-files -d 'Keep installed files on disk'
complete -c openclaw -n "__fish_seen_subcommand_from uninstall" -l keep-config -d 'Deprecated alias for --keep-files'
complete -c openclaw -n "__fish_seen_subcommand_from uninstall" -l force -d 'Skip confirmation prompt'
complete -c openclaw -n "__fish_seen_subcommand_from uninstall" -l dry-run -d 'Show what would be removed without making changes'
complete -c openclaw -n "__fish_seen_subcommand_from install" -s l -l link -d 'Link a local path instead of copying'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l pin -d 'Record npm installs as exact resolved <name>@<version>'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l dangerously-force-unsafe-install -d 'Bypass built-in dangerous-code install blocking (plugin hooks may still block)'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l marketplace -d 'Install a Claude marketplace plugin from a local repo/path or git/GitHub source'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l all -d 'Update all tracked plugins and hook packs'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l dry-run -d 'Show what would change without writing'
complete -c openclaw -n "__fish_seen_subcommand_from marketplace" -a "list" -d 'List plugins published by a marketplace source'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from capabilities" -l channel -d 'Channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line)'
...
complete -c openclaw -n "__fish_seen_subcommand_from resolve" -l channel -d 'Channel (telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l channel -d 'Channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l private-key -d 'Nostr private key (nsec... or hex)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l relay-urls -d 'Nostr relay URLs (comma-separated)'
...
complete -c openclaw -n "__fish_seen_subcommand_from login" -l channel -d 'Channel alias (auto when only one is configured)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l channel -d 'Channel alias (auto when only one is configured)'
...
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l token -d 'Use explicit gateway token for deep probe auth'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l password -d 'Use explicit gateway password for deep probe auth'
...
complete -c openclaw -n "__fish_seen_subcommand_from secrets" -a "reload" -d 'Re-resolve secret references and atomically swap runtime snapshot'
complete -c openclaw -n "__fish_seen_subcommand_from secrets" -a "audit" -d 'Audit plaintext secrets, unresolved refs, and precedence drift'
complete -c openclaw -n "__fish_seen_subcommand_from secrets" -a "configure" -d 'Interactive secrets helper (provider setup + SecretRef mapping + preflight)'
complete -c openclaw -n "__fish_seen_subcommand_from secrets" -a "apply" -d 'Apply a previously generated secrets plan'
complete -c openclaw -n "__fish_seen_subcommand_from reload" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from reload" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from reload" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from reload" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from reload" -l expect-final -d 'Wait for final response (agent)'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l check -d 'Exit non-zero when findings are present'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l allow-exec -d 'Allow exec SecretRef resolution during audit (may execute provider commands)'
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l apply -d 'Apply changes immediately after preflight'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l yes -d 'Skip apply confirmation prompt'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l providers-only -d 'Configure secrets.providers only, skip credential mapping'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l skip-provider-setup -d 'Skip provider setup and only map credential fields to existing providers'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l agent -d 'Agent id for auth-profiles targets (default: configured default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l allow-exec -d 'Allow exec SecretRef preflight checks (may execute provider commands)'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l plan-out -d 'Write generated plan JSON to a file'
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l from -d 'Path to plan JSON'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l dry-run -d 'Validate/preflight only'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l allow-exec -d 'Allow exec SecretRef checks (may execute provider commands)'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from skills" -a "search" -d 'Search ClawHub skills'
complete -c openclaw -n "__fish_seen_subcommand_from skills" -a "install" -d 'Install a skill from ClawHub into the active workspace'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l limit -d 'Max results'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l version -d 'Install a specific version'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l force -d 'Overwrite an existing workspace skill'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l all -d 'Update all tracked ClawHub skills'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from update" -l dry-run -d 'Preview update actions without making changes'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l channel -d 'Persist update channel (git + npm)'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l tag -d 'Override the package target for this update (dist-tag, version, or package spec)'
